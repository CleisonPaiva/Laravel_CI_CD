...
class LessonTest extends TestCase
{
    ...
    public function test_get_all_lessons_by_module()
    {
        ...
        $response = $this->getJson("/api/modules/{$module->uuid}/lessons");
    ...
    public function test_get_lesson_by_module()
    {
        ...
        $response = $this->getJson("/api/modules/{$module->uuid}/lessons/{$lesson->uuid}");
    ...
    public function test_validations_create_lesson_by_module()
    {
        ...
        $response = $this->postJson("/api/modules/{$module->uuid}/lessons", []);
    ...
    public function test_validations_update_lesson_by_module()
    {
        ...
        $response = $this->putJson("/api/modules/{$module->uuid}/lessons/{$lesson->uuid}", []);
    ...
    public function test_notfound_delete_lesson_by_module()
    {
        ...
        $response = $this->deleteJson("/api/modules/{$module->uuid}/lessons/fake_module");
    ...
    public function test_delete_lesson_by_module()
    {
        ...
        $response = $this->deleteJson("/api/modules/{$module->uuid}/lessons/{$lesson->uuid}");
